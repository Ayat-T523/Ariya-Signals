...
// RESTORED COMPETITORS EXPERIENCE (2026-08-25): the legacy-id-matched
// CompetitorCard / honest-minimal TrackedCompetitorCard split this section
// previously asserted was intentionally REPLACED by a single unified
// V1CompetitorCard for every real tracked competitor once a real active
...
console.log('13. War Room semantic-integrity checkpoint (2026-08-25, header renamed 2026-08-26): "Top signals to triage" rename, no hidden HIGH/MEDIUM-only gate, Market Weather/Upcoming Events legacy-source isolation')
assertTrue('the worklist heading renders "Top signals to triage" regardless of landscape state (2026-08-26 rename)', warRoomSource.includes('Top signals to triage'))
